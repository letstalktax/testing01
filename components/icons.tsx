  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1 2C1 1.44772 1.44772 1 2 1H14C14.5523 1 15 1.44772 15 2V14C15 14.5523 14.5523 15 14 15H2C1.44772 15 1 14.5523 1 14V2ZM2.5 2.5V5.5H6.5V2.5H2.5ZM2.5 7V10H6.5V7H2.5ZM2.5 11.5V13.5H6.5V11.5H2.5ZM8 2.5V5.5H13.5V2.5H8ZM13.5 7H8V10H13.5V7ZM8 11.5V13.5H13.5V11.5H8Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const LogoMusTax = ({ className = '', size = 120 }: { className?: string; size?: number }) => {
  const { theme } = useTheme();
  const [logoUrl, setLogoUrl] = useState('https://i.postimg.cc/Y9BPdcKk/1.png'); // Default to black logo
  
  useEffect(() => {
    // Update logo URL based on theme after component mounts
    setLogoUrl(theme === 'dark' 
      ? 'https://i.postimg.cc/s2sSmK6q/2.png'  // White logo for dark mode
      : 'https://i.postimg.cc/Y9BPdcKk/1.png'  // Black logo for light mode
    );
  }, [theme]);
  ...
  return (
    <div className={`relative ${className}`} style={{ width: size, height: size * 0.4 }}>
      <Image
        ...
        priority
        unoptimized // Use this since we're loading from external URL
      />
    </div>
  );
};
